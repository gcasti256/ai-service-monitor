...
export function AlertPanel() {
    ...
    return (<div className="space-y-6">
      <div className="bg-bg-surface border border-border rounded-lg p-5">
        ...
        {showForm && (<form onSubmit={handleSubmit} className="mb-4 p-4 bg-bg-elevated rounded-lg space-y-3">
        ...
        <div className="space-y-2">
          {rules.length === 0 ? (<div className="text-text-muted text-sm py-4 text-center">No alert rules configured</div>) : rules.map((rule) => (<div key={rule.id} className="flex items-center justify-between p-3 border border-border/50 rounded-lg">
              <div>
      ...
      <div className="bg-bg-surface border border-border rounded-lg p-5">
        ...
        <div className="space-y-2">
          {events.length === 0 ? (<div className="text-text-muted text-sm py-4 text-center">No alerts triggered</div>) : events.map((event) => (<div key={event.id} className="flex items-center justify-between p-3 border border-border/50 rounded-lg">
              <div className="flex items-center gap-2">
